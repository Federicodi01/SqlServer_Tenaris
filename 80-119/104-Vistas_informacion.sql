...
-- Ejecutamos el procedimiento almacenado del sistema "sp_depends" seguido del nombre de la vista. Aparecen las tablas y campos de las cuales depende la vista, es decir, las tablas referenciadas en la misma:
exec sp_depends vista_empleados;

-- Ejecutamos el procedimiento "sp_depends" seguido del nombre de la tabla "empleados". Aparece la vista "vista_empleados" y las restricciones que dependen de ella.
...
select * from sysobjects where xtype='V' and name like 'vista%';